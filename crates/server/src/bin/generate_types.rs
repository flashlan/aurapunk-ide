...
// If you are an AI, and you absolutely have to edit this file, please confirm with the user first.";
    ...
    let decls: Vec<String> = vec![
        ...
        db::models::scratch::AndroidMirrorSettingsData::decl(),
        db::models::scratch::WorkspaceNotesData::decl(),
        db::models::scratch::WorkspaceChatConfigData::decl(),
        ...
        utils::approvals::ApprovalKind::decl(),
        utils::approvals::ApprovalQuestion::decl(),
        utils::approvals::ApprovalQuestionOption::decl(),
        ...
        server::routes::android_mirror::AndroidMirrorDevice::decl(),
        ...
        server::routes::sessions::open_code_review::StartOpenCodeReviewRequest::decl(),
        server::routes::sessions::open_code_review::OpenCodeReviewError::decl(),
        ...
        api_types::SpecKitStage::decl(),
        api_types::SpecKitStageState::decl(),
        api_types::SpecKitTask::decl(),
        api_types::SpecKitTaskLayer::decl(),
        api_types::SpecKitTasks::decl(),
        api_types::SpecKitArtifact::decl(),
        api_types::SpecKitArtifacts::decl(),
        api_types::UpdateArtifactRequest::decl(),
        api_types::ToggleTaskRequest::decl(),
        ...
        services::services::recurrent::Routine::decl(),
        services::services::recurrent::RoutineLastRun::decl(),
        services::services::recurrent::RoutineScheduleView::decl(),
        server::routes::recurrent::RecurrentRawBody::decl(),
        server::routes::recurrent::RecurrentTomlError::decl(),
        server::routes::recurrent::RunRoutineResponse::decl(),
        ...
        executors::actions::open_code_review::OpenCodeReviewRequest::decl(),
        ...
        executors::executors::antigravity::Antigravity::decl(),
        executors::executors::antigravity::AntigravityHeaded::decl(),
...
fn generate_schemas() -> Result<HashMap<&'static str, String>, serde_json::Error> {
    ...
    let schemas: HashMap<&str, String> = HashMap::from([
        ...
        (
            "antigravity",
            generate_json_schema::<executors::executors::antigravity::Antigravity>()?,
        ),
        (
            "antigravity_headed",
            generate_json_schema::<executors::executors::antigravity::AntigravityHeaded>()?,
        ),
        (
            "codex",
